...
-- AddForeignKey
ALTER TABLE "inquiry" ADD CONSTRAINT "inquiry_customer_service_representative_id_fkey" FOREIGN KEY ("customer_service_representative_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
